...
export default function FoundersSection() {
  ...
  return (
    <section className="relative bg-white py-24 text-zinc-900 border-b border-zinc-200 overflow-hidden">
      <div className="container-custom relative z-10 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-5xl font-extrabold font-heading uppercase tracking-tight text-zinc-900"
          >
          ...
          <motion.p
            ...
            className="text-base text-zinc-600 font-normal leading-relaxed max-w-2xl mx-auto"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {leaders.map((leader, index) => (
            <motion.div
              ...
              className="group relative border border-zinc-200 bg-zinc-50 p-8 sm:p-10 transition-all duration-300 hover:border-zinc-300 hover:shadow-xl flex flex-col justify-between"
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 border-b border-zinc-200 pb-6">
                  {/* Portrait Placeholder Area */}
                  <div className="relative flex h-24 w-24 shrink-0 items-center justify-center rounded-sm border border-zinc-200 bg-white font-mono text-2xl font-extrabold text-[#E31B2B] shadow-sm group-hover:border-[#E31B2B]/60 transition-all duration-300">
                  ...
                  <div className="space-y-1">
                    ...
                    <h3 className="text-2xl sm:text-3xl font-bold font-heading uppercase text-zinc-900 tracking-tight">
                      {leader.name}
                    </h3>
                    <div className="flex items-center gap-2 pt-1 text-[11px] font-mono text-zinc-600">
                ...
                {/* Short Intro */}
                <p className="text-sm text-zinc-800 leading-relaxed font-medium border-l-2 border-[#E31B2B]/80 pl-4 py-0.5">
                  "{leader.intro}"
                </p>
                ...
                <div className="space-y-3 pt-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {leader.coreFocus.map((focus) => (
                      <span
                        key={focus}
                        className="bg-white px-3 py-1.5 text-xs font-mono text-zinc-800 border border-zinc-200 rounded-sm group-hover:border-zinc-300 transition-colors"
                      >
                        {focus}
                      </span>
                    ))}
              ...
              {/* Bottom Actions & CTA */}
              <div className="mt-8 pt-6 border-t border-zinc-200 flex items-center justify-between flex-wrap gap-4">
                <div className="flex items-center gap-3 text-zinc-600 text-xs font-mono">
                  <a
                    ...
                    className="hover:text-[#E31B2B] transition-colors p-2 rounded bg-white border border-zinc-200"
