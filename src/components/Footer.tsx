  ...
  return (
    <footer className="bg-zinc-50 border-t border-zinc-200 pt-16 pb-8 text-zinc-600">
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 pb-16 border-b border-zinc-200">
          ...
          {/* Services Quick List */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-zinc-900 uppercase tracking-wider">Services</h3>
            <div className="w-8 h-[2px] bg-[#E31B2B]" />
            <ul className="space-y-2.5 text-sm text-zinc-700">
              <li>
          ...
          {/* Contact Details */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-zinc-900 uppercase tracking-wider">Contact Info</h3>
            <div className="w-8 h-[2px] bg-[#E31B2B]" />
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={companyInfo.whatsappLink} target="_blank" rel="noopener noreferrer" className="hover:text-black font-medium text-zinc-800 transition-colors">
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={`mailto:${companyInfo.email}`} className="hover:text-black font-medium text-zinc-800 transition-colors">
                    {companyInfo.email}
                  </a>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <a href={companyInfo.websiteUrl} target="_blank" rel="noopener noreferrer" className="hover:text-black font-medium text-zinc-800 transition-colors">
                    {companyInfo.website}
                  </a>
                </div>
              </li>
            ...
            <div className="pt-2 flex items-center gap-3">
              <a
                ...
                className="p-2 rounded bg-white border border-zinc-200 text-zinc-700 hover:text-[#E31B2B] hover:border-[#E31B2B] transition-colors"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="px-2.5 py-1.5 rounded bg-white border border-zinc-200 text-zinc-700 hover:text-[#E31B2B] hover:border-[#E31B2B] transition-colors text-xs font-semibold"
              >
                WA
              </a>
            </div>
