  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "py-3 bg-black/95 backdrop-blur-md border-b border-zinc-800 shadow-lg"
          : "py-4 bg-black/80 border-b border-zinc-900"
      }`}
    >
...
<<<<<<< HEAD
                className={`relative py-1 text-sm font-medium transition-colors duration-200 ${
                  isActive ? "text-[#E31B2B] font-semibold" : "text-zinc-300 hover:text-white"
                }`}
              >
                {link.name}
                {isActive && (
...
<<<<<<< HEAD
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            ...
            className="md:hidden p-2 text-zinc-300 hover:text-white bg-zinc-900 border border-zinc-800 rounded-md transition-colors"
...
<<<<<<< HEAD
            ...
            className="absolute left-0 top-full w-full border-b border-zinc-800 bg-black/95 backdrop-blur-xl md:hidden overflow-hidden shadow-2xl"
          >
...
<<<<<<< HEAD
                    className={`block px-4 py-3 text-sm font-medium rounded-md transition-all duration-200 ${
                      isActive
                        ? "bg-zinc-900 text-[#E31B2B] border-l-4 border-[#E31B2B]"
