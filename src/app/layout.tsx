...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="font-sans antialiased bg-white text-zinc-900 selection:bg-[#E31B2B]/20 selection:text-black" suppressHydrationWarning>
        <PageLoader />
        <CustomCursor />
        <SmoothScroll>
          <div className="relative flex min-h-screen flex-col bg-white selection:bg-[#E31B2B]/20 selection:text-black">
            <Navbar />
