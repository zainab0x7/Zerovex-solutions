      ...
      <section className="relative py-20 bg-gradient-to-b from-zinc-50 to-white text-center border-b border-zinc-200 overflow-hidden">
        <div className="container-custom relative z-10 max-w-4xl mx-auto space-y-6">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-6xl font-extrabold uppercase tracking-tight leading-[1.05] text-zinc-900 font-heading"
          >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-zinc-600 font-normal max-w-2xl mx-auto leading-relaxed"
          >
